...
{
    public abstract class BrighterPathWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BrighterPathWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BrighterPathWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BrighterPathDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BrighterPathDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BrighterPathDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BrighterPathDbContext, Task<T>> func)
        {
            T result;
